            ...
            <div class="col-4">
                ...
                <form action="koneksi.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" name="idDokter" placeholder="ID">
                    </div>
                    <div class="form-group">
                        <label for="nmDokter">Nama Dokter</label>
                        <input type="text" class="form-control mb-3" name="nmDokter" placeholder="Nama">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea name="noTelp" id="noTelp" cols="5" rows="3" placeholder="No Telp" class="form-control"></textarea>
                    </div>
                    <div class="form-group mt-3">
